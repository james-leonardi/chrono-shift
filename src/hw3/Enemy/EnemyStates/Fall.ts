...
export default class Fall extends EnemyState {
    ...
    update(deltaT: number): void {
        ...
        // If the enemy hits the ground, start idling and check if we should take damage
        ...
        // Otherwise, keep moving
            ...
            // Get the movement direction from the enemy 
